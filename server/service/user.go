...
func BuildUser(ctx context.Context, data *model.User) (user *types.UserInfoResp) {
...
func BuildUsers(ctx context.Context, datas []*model.User) (users []*types.UserInfoResp) {
